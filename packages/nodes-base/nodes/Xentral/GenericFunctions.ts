 ...
 * @returns {Promise<any>}
 */
export async function xentralRequest(this: IHookFunctions | IExecuteFunctions, method: string, endpoint: string, body: IDataObject): Promise<any> { // tslint:disable-line:no-any
